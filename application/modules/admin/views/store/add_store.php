        ...
        <header id="topbar" class="alt">
            <div class="topbar-left">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-current-item">Add Store</li>
                </ol>
            </div>
                    ...
                    <div class="tab-content mw900 center-block center-children">
                        ...
                        <div class="allcp-form theme-info tab-pane mw600 active" id="contact" role="tabpanel">
                            <div class="panel">
                                ...
                                <form method="post" action="<?php echo base_url();?>admin/store/insert_store" id="form-contact1">
                                    <div class="panel-body pn">
                                        <div class="section">
                                            <label for="names" class="field prepend-icon">
                                                <input type="text" name="store_name" id="store_name" class="gui-input" placeholder="Store Name" style="padding-left: 5px;" required/>
                                            </label>
                                        </div>
                                        <!-- <div class="section">
