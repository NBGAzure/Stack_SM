        ...
        <header id="topbar" class="alt">
            <div class="topbar-left">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-current-item">Store List</li>
                </ol>
            </div>
            ...
            <div class="chute chute-center">
                 <div class="panel panel-visible" id="spy6">
                    ...
                    <div class="panel-heading">
                        <span class="panel-title">Store List</span>

                        <div class="pull-right hidden-xs">
                            <code><a class="btn-dark" href="<?php echo base_url()?>admin/Store/addstore" style="padding: 10px;">Add Store</a></code>
                        </div>
                    </div>
                             ...
                             <table class="table table-striped table-hover" id="datatable2" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    <?php
                                      ...
                                      {
                                        //print_r($val->visible_for);
                                        //$vis = explode( ',', $val->visible_for ) ;
                                    ?>
                                        <tr class="footable-even">
                                            ...
                                            <!-- <td>
                                              <?php 
                                                foreach($vis as $value) {
                                                    $query = $this->db->query("SELECT * from user_master WHERE `uid` = ".$value." ")->row();
                                            ...
                                            <td>
                                                <a class="btn-primary" href="<?php echo base_url()?>admin/Store/editstore/<?php echo $val->str_id; ?>" id="edit" title='Edit' style="padding: 5px 15px;margin-right: 10px;">Edit</a>
                                                <a class="btn-danger" href="javascript:frm_submit(<?php print $val->str_id?>,'Delete');" id="delete" title='Delete' style="padding: 5px;">Delete</a> 
                                            </td>
                                        </tr>
                                    <?php
                                        $i++;
                                ...
                                <?php 
                                  ...
                                  echo form_open('admin/Store/delete_store/',$attributes); 
                                ?>  
...
function frm_submit(list_id,actval)
{
 ...
 var result = confirm("Are you sure you want to delete?");
  if (result) {
   document.frm.action = "<?php echo base_url()?>admin/Store/delete_store/<?php echo $val->str_id; ?>";
   document.frm.submit();
   return
   }
  }
