                    ...
                    <div class="tab-content mw900 center-block center-children">
                        ...
                        <div class="allcp-form theme-info tab-pane mw600 active" id="contact" role="tabpanel">
                            <div class="panel">
                                ...
                                <form method="post" action="<?php echo base_url();?>admin/User/insert_user" id="form-contact1">
                                    <div class="panel-body pn">
                                        <div class="section">
                                            <label for="names" class="field prepend-icon">
                                                <input type="hidden" name="user_role" id="user_role" class="gui-input" value="user">
                                            </label>
                                        </div>

                                        <div class="section">
                                            <label for="names" class="field prepend-icon">
                                                <input type="text" name="user_name" id="user_name" class="gui-input" placeholder="User Name" style="padding-left: 5px;" required/>
                                            </label>
                                        </div>
