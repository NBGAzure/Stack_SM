        ...
        <header id="topbar" class="alt">
            <div class="topbar-left">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-current-item">Product Stock List</li>
                </ol>
            </div>
            ...
            <div class="chute chute-center">
                 <div class="panel panel-visible" id="spy6">
                    ...
                    <div class="panel-heading">
                        <span class="panel-title">Product Stock List</span>

                        <div class="pull-right hidden-xs">
                            <code><a class="btn-dark" href="<?php echo base_url()?>admin/Productstock/addproductstock" style="padding: 10px;">Add Product Stock</a></code>
                        </div>
                    </div>
                            ...
                            ?>
                             <table class="table table-striped table-hover" id="datatable2" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    <?php
                                      $i=1;
                                      foreach($productstock_data as $val)
                                      {
                                    ...
                                    ?>
                                        <tr class="footable-even">
                                            ...
                                            <td>
                                                <a class="btn-primary" href="<?php echo base_url()?>admin/Productstock/editproductstock/<?php echo $val->id; ?>" id="edit" title='Edit' style="padding: 5px 15px;margin-right: 10px;">Edit</a>
                                ...
                                <?php 
                                  ...
                                  echo form_open('admin/Productstock/delete_productstock/',$attributes); 
                                ?>  
...
function frm_submit(list_id,actval)
{
 ...
 var result = confirm("Are you sure you want to delete?");
  if (result) {
   document.frm.action = "<?php echo base_url()?>admin/Productstock/delete_productstock/<?php echo $val->id; ?>";
   document.frm.submit();
   return
   }
  }
