                                        ...
                                        ?>
                                            <tr class="footable-even">
                                                ...
                                                <td>
                                                    ...
                                                    <input type="checkbox" id="checkItem[]" name="check_val[<?php echo $val->product_id;?>][]" value="1"  <?php if(isset($val->check_val) && $val->check_val=="1"){echo "checked = checked";}else{echo "";}?>>
                                                </td>
                                            </tr>
                                        <?php 
                                            $i++;
