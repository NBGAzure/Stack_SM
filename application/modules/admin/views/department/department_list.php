                 ...
                 <div class="panel panel-visible" id="spy6">
                    ...
                    <div class="panel-heading">
                        ...
                        <div class="pull-right hidden-xs">
                            <code><a class="btn-dark" href="<?php echo base_url()?>admin/Department/adddepartment" style="padding: 10px;">Add Department</a></code>
                        </div>
                    </div>
                            ...
                            ?>
                             <table class="table table-striped table-hover" id="datatable2" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr class="footable-even">
                                            ...
                                            <td>
                                                <a class="btn-primary" href="<?php echo base_url()?>admin/Department/editdepartment/<?php echo $val->dept_id; ?>" id="edit" title='Edit' style="padding: 5px 15px;margin-right: 10px;">Edit</a>
                                                <a class="btn-danger" href="javascript:frm_submit(<?php print $val->dept_id?>,'Delete');" id="delete" title='Delete' style="padding: 5px;">Delete</a> 
                                            </td>
                                        </tr>
                                    <?php
                                        $i++;
                                ...
                                <?php 
                                  ...
                                  echo form_open('admin/Department/delete_department/',$attributes); 
                                ?>  
...
function frm_submit(list_id,actval)
{
 ...
 var result = confirm("Are you sure you want to delete?");
  if (result) {
   document.frm.action = "<?php echo base_url()?>admin/Department/delete_department/<?php echo $val->dept_id; ?>";
   document.frm.submit();
   return
   }
  }
