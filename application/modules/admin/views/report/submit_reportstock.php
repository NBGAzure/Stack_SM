                    ...
                    <div class="tab-content center-block center-children">
                        ...
                        <div class="allcp-form theme-info tab-pane active" id="contact" role="tabpanel">
                            <div class="panel">
                                ...
                                {
                                ?>
                                <form method="post" action="<?php echo base_url();?>admin/Report/submit_tillreportstock" id="form-contact1">
                                  <table class="table table-striped table-hover" id="datatable2" cellspacing="0" width="100%">
                                    ...
                                    <div class="section text-right">
                                        <input type="submit" class="btn btn-success btn-bordered ph40" value="SUBMIT">
                                    </div>
                                </form>
