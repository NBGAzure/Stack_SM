        ...
        <header id="topbar" class="alt">
            <div class="topbar-left">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-current-item">Product List</li>
                </ol>
            </div>
                 ...
                 <div class="panel panel-visible" id="spy6">
                    ...
                    <div class="panel-heading">
                        ...
                        <div class="pull-right hidden-xs">
                            <code><a class="btn-dark" href="<?php echo base_url()?>admin/Product/addproduct" style="padding: 10px;">Add Product</a></code>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr class="footable-even">
                                            ...
                                            <td>
                                                <a class="btn-primary" href="<?php echo base_url()?>admin/Product/editproduct/<?php echo $val->product_id; ?>" id="edit" title='Edit' style="padding: 5px 15px;margin-right: 10px;">Edit</a>
                                                <a class="btn-danger" href="javascript:frm_submit(<?php print $val->product_id?>,'Delete');" id="delete" title='Delete' style="padding: 5px;">Delete</a> 
                                            </td>
                                        </tr>
                                    <?php
                                        $i++;
