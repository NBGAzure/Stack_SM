...
abstract class REST_Controller extends CI_Controller {
    ...
    const HTTP_NETWORK_AUTHENTICATION_REQUIRED = 511;
	 /**
     * Signup message in api
     */
	const HTTP_NOT_EMAIL = 601;
	const HTTP_NOT_USERNAME = 602;
	const HTTP_INVALID_BOTH = 603;
    ...
    protected $http_status_codes = [
		...
		self::HTTP_NOT_EMAIL => 'INVALID EMAIL ADDRESS',
		self::HTTP_NOT_USERNAME => 'INVALID USERNAME',
		self::HTTP_INVALID_BOTH => 'INVALID USERNAME AND EMAIL'
    ];
...
//		$http_code = $data['data']['response_code']; // store for log table (custome code)
		...
		if(!$isProfilingEnabled){
			...
			//$http_code = $data['data']['response_code'];
